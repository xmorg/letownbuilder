...
function show_transaction_menu() --allows you to choose what you are selling.
	...
	if merchant_window.active_inventory == "kingdom" then love.graphics.setColor(200,200,200,255) else
	...
	if merchant_window.active_inventory == "merchant" then love.graphics.setColor(200,200,200,255) else
	love.graphics.setColor(255,255,255,255) --active_inventory = "kingdom"
	end
