...
lookup_table = {"wood", "sakura", "bamboo", "carrots", 
		...
		"cherries", "fishwine", "paleale", "rocks", 
		"iron_ore", "iron_ingots", "gold_ore", 
		"gold_ingots",
		"women",
		"men" }
merchant_inventory = { --only includes tradeable items.
   wood = 0, sakura = 0, bamboo = 0, carrots = 0, 
   sansai = 0, raw_meat =0, smoked_meat = 0, tomatoes = 0,
   mushrooms = 0, fish = 0, smoked_fish = 0, grain = 0, 
   cherries = 0, fishwine = 0, paleale=0, rocks = 0, 
   iron_ore = 0, iron_ingots = 0, gold_ore = 0, 
   gold_ingots = 0,
   women = 0,
   men = 0
}
function show_transaction_menu() --allows you to choose what you are selling.
	...
	love.graphics.setColor(255,255,255,255)
	love.graphics.rectangle("fill", tx+10, ty+10, townframe_x, town_frame_y) --town window
	love.graphics.rectangle("fill", tx+10+townframe_x+10, ty+10, townframe_x, town_frame_y) --merchants window
	--now list the town items at tx+10
	
	--now list the merchant items at x+10+townframe_x+10
end
